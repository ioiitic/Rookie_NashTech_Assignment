...
namespace R2EShop.Infrastructure.Migrations
{
    ...
    [Migration("20240531030844_Update_Category_PhoneCase")]
    partial class Update_Category_PhoneCase
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryPhoneCase", b =>
                {
                    ...
                    b.Property<Guid>("PhoneCasesId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("CategoriesId", "PhoneCasesId");

                    b.HasIndex("PhoneCasesId");
            ...
            modelBuilder.Entity("R2EShop.Domain.Entities.PhoneCase", b =>
                {
                    b.HasOne("R2EShop.Domain.Entities.Artwork", null)
                        .WithMany("PhoneCases")
                        .HasForeignKey("ArtworkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("R2EShop.Domain.Entities.CaseType", null)
                        .WithMany("PhoneCases")
